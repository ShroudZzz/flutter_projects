...
class GridView extends StatelessWidget {
  ...
  _gridNavItem(BuildContext context, GridNavItem gridNavItem, bool first) {
    ...
    items.add(_subItem(context, gridNavItem.item1, gridNavItem.item2));
  ...
  _subItem(BuildContext context, CommonModel topItem, CommonModel bottomItem) {
    return Column(
      children: [
  ...
  _wrapGesture(BuildContext context, Widget widget, CommonModel model) {
    return GestureDetector(
      onTap: () {
        //Navigator.push(context, (context) => webView)
      },
      child: widget,
    );
  }
